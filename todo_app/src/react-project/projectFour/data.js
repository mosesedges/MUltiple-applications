...
const data = [
...

  {
    ...
    answer:'Watch Netflix on your smartphone, tablet, smart TV, laptop or streaming device, all for one fixed monthly fee. Plans range from NGN2,900 to NGN4,400 a month. No extra costs, no contracts.',
